...
class MainActivity : Activity() {
    ...
    private fun showHome(){
        ...
        root.addView(tv("ALX DESIGN STUDIO 3D",28f,true)); root.addView(tv("Suite de diseño • Hoja de ruta en implementación",15f))
    ...
    private fun showLightingModule(){
        ...
        fun tool(n:String,k:String){row.addView(button(n){canvas.applyTool(k)},LinearLayout.LayoutParams(155,58).apply{setMargins(4,0,4,0)})}
        tool("Sol","Sol");tool("Puntual","Puntual");tool("Área","Área");tool("Spot","Spot");tool("Sombras","Sombras");tool("Ambiente","Ambiente");tool("HDRI","HDRI");tool("Cámara","Cámara");tool("Prof. campo","DOF");tool("Calidad","Calidad");tool("Render","Render")
